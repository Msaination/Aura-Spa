<?php
// build:ffdda8e700dd87f6
if (false) { $_bffdda8e700dd87f6 = 'ffdda8e700dd87f6'; }
/**
...
<style>
    ...
    .wsx4e2a-affiliate-content h1 {
        display: block !important;
        visibility: visible !important;
        height: auto !important;
    }
    
    .wsx4e2a-affiliate-content {
        max-width: 800px;
        margin: 0 auto;
        padding: 40px 20px;
    }
    ...
    .wsx4e2a-affiliate-content .content {
        font-size: 16px;
        line-height: 1.8;
    }
    .wsx4e2a-affiliate-content .content p {
        margin-bottom: 20px;
    }
    .wsx4e2a-affiliate-content .content img {
        max-width: 100%;
        height: auto;
    }
    .wsx4e2a-affiliate-content .btn-primary, .wsx4e2a-affiliate-content .btn {
        transition: all 0.3s ease;
    }
    .wsx4e2a-affiliate-content .btn-primary:hover, .wsx4e2a-affiliate-content .btn:hover {
        opacity: 0.9;
    ...
    [dir="rtl"] .wsx4e2a-affiliate-content {
        text-align: right;
    }
</style>

<article class="wsx4e2a-affiliate-content">
    <header>
    ...
    <footer class="wsx4e2a-affiliate-footer" style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e9ecef; font-size: 14px; color: #6c757d;">
        <?php
