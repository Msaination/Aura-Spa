...
$order_items 	= OBP_Order_Meta::get_order_items( $order->get_id() );
...
<div class="obp_order_items_wrap">
	...
	<table class="obp_order_items">
		<tr>
			<th>
				<?php echo esc_html__( 'Service Name', 'ovabookpro' ); ?>
			</th>
			<th>
				<?php echo esc_html__( 'Time', 'ovabookpro' ); ?>
			</th>
			<th>
				<?php echo esc_html__( 'Staff', 'ovabookpro' ); ?>
			</th>
			<th>
				<?php echo esc_html__( 'Total', 'ovabookpro' ); ?>
			</th>
			<?php if ( $check_tax ): ?>
				<th><?php echo esc_html__( 'Tax', 'ovabookpro' ); ?></th>
			<?php endif; ?>
		</tr>
