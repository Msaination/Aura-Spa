...
<tr>
	<td>
		...
		data-tippy-content="<?php echo esc_attr__( 'View Booking', 'ovabookpro' ); ?>"
	...
	<td>
		<?php echo wp_kses_post( obp_show_booking_total( $order->get_vendor_total(), $order->has_varies() ) ); ?>
	</td>
				...
				<?php foreach ( $order_items as $order_item ):
					...
					<li class="item">
						<p class="service_name">
							<?php echo esc_html( $obj->get_service_name() ); ?>
						...
						<p class="info">
							<span class="time"><?php echo esc_html( $obj->get_time() ); ?></span>
							<span class="staff_name"><?php echo esc_html( $obj->get_staff_name() ); ?></span>
						</p>
					</li>
				<?php endforeach; ?>
			</ul>
	...
	<td>
		<div class="order_action_wrapper">
			...
			data-tippy-content="<?php echo esc_attr__( 'Download Invoice', 'ovabookpro' ); ?>">
			...
			<?php if ( $order_status == 'obp_processing' ): ?>
				...
				<?php if ( $check_change === true ): ?>
					...
					data-tippy-content="<?php echo esc_attr__( 'Change', 'ovabookpro' ); ?>">
				...
				<?php if ( $check_cancel === true ): ?>
					...
					data-tippy-content="<?php echo esc_attr__( 'Cancel', 'ovabookpro' ); ?>">
