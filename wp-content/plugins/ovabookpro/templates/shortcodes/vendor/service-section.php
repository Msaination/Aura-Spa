	...
	<?php foreach ( $services as $key => $group ):
		...
		<div class="service-section">
			...
			<div class="service-counter">
				<?php printf( _n( '%s Service', '%s Services', $count, 'ovabookpro' ), number_format_i18n( $count ) );; ?>
			</div>
		</div>
		<?php
		obp_get_template( "shortcodes/vendor/service-items.php", array( 'service_ids' => $group['services'] ) );
		}
		?>
	<?php endforeach; ?>
<?php else: ?>
