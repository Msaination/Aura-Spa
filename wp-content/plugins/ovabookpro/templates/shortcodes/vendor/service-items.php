...
$date_timestamp = strtotime( date("Y-m-d", current_time( 'timestamp' ) ) );
				...
				<div class="service-info">
					...
					<?php if ( ! empty( $service->get_price_on_sale_off_date( $date_timestamp ) ) ): ?>
						<div class="service_save">
							<span><?php echo sprintf( esc_html__( 'Save up to %d%%', 'ovabookpro' ), $service->get_percent_sale_off() ); ?></span>
						</div>
					<?php endif; ?>
				</div>
						...
						<div class="price">
							<?php if ( ! empty( $service->get_price_on_sale_off_date( $date_timestamp ) ) ): ?>
								<span class="old_price">
									<?php echo obp_get_price_html( obp_show_price_item( $service->get_price(), $service->get_rates() ), $service->get_price_type() ); ?>
								</span>
								<span class="sale_price">
									<?php echo obp_get_price_html( obp_show_price_item( $service->get_price_on_sale_off_date( $date_timestamp ), $service->get_rates() ) , $service->get_price_type() ); ?>
								</span>
							<?php else: ?>
								<?php echo obp_get_price_html( obp_show_price_item( $service->get_price(), $service->get_rates() ), $service->get_price_type(), $service->get_note_price() ); ?>
							<?php endif; ?>
						</div>
