<?php defined( 'ABSPATH' ) || exit;
	global $post;
	$services = BookPro\Service\OBP_Service::get_list_service_ajax( $vendor_id );
?>
...
<div class="single-business-part service-wrap">
	...
	<div class="service-results" data-vendor-id="<?php echo esc_attr( $vendor_id ); ?>"
		...
		<?php obp_get_template( 'my-business/single-business/service-section.php', array( 'services' => $services ) ); ?>
	</div>
